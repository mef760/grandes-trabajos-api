...
namespace GrandesTrabajos.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = GrandesTrabajosConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(GrandesTrabajosDbContext context)
        {
            _context = context;
        }
