...
{
    public abstract class GrandesTrabajosWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GrandesTrabajosWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GrandesTrabajosWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GrandesTrabajosDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GrandesTrabajosDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GrandesTrabajosDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GrandesTrabajosDbContext, Task<T>> func)
        {
            T result;
